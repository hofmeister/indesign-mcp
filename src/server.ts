...
1c. When you already know several steps, put them in one batch call instead of one call each: it runs them in order and writes the file once. Build a page that way rather than a call per frame.
